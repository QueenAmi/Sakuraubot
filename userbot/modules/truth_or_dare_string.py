TRUTH = [
    ...
    "Apabila kamu cewe bersedia kah untuk menjadi pacar owner ku @Usern4meDoestExist404",
    ...
    "si @Usern4meDoestExist404 menurut ku dia ganteng, coba deh kamu chat, trus ajak pacaran hehe ⚠️WARNING ini khusus cewe ya!",
...
DARE = [
     ...
     "Bilang ke @Usern4meDoestExist404 bahwa dia ganteng",
     "Vn cium ke @Usern4meDoestExist404",
