...
__MODULE__ = "ᴛᴏxɪᴄ𝟸"
__HELP__ = f"""
<blockquote><b>ɴɢᴀᴛᴀ ɴɢᴀᴛᴀɪɴ ᴀᴊᴀ:

➢ ᴘᴇʀɪɴᴛᴀʜ: `malu` - coba aja.
➢ ᴘᴇʀɪɴᴛᴀʜ: `curhat` - coba aja.
➢ ᴘᴇʀɪɴᴛᴀʜ: `umm` - coba aja.
➢ ᴘᴇʀɪɴᴛᴀʜ: `knl` - coba aja.
➢ ᴘᴇʀɪɴᴛᴀʜ: `bi` - coba aja.
➢ ᴘᴇʀɪɴᴛᴀʜ: `hai` - coba aja.
➢ ᴘᴇʀɪɴᴛᴀʜ: `psn` - coba aja.
➢ ᴘᴇʀɪɴᴛᴀʜ: `kasihan` - coba aja.
➢ ᴘᴇʀɪɴᴛᴀʜ: `rosting` - coba aja.
➢ ᴘᴇʀɪɴᴛᴀʜ: `peka` - coba aja.<b></blockquote>
"""
