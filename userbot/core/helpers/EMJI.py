...
class EMO:
    async def PING(client):
        ...
        emot_ping = emot_1 if emot_1 else "5972055534352733289"
    ...
    async def MENTION(client):
        ...
        emot_xbot = emot_3 if emot_3 else "5971867376130461576"
        if client.me.is_premium:
    ...
    async def MENUNGGU(client):
        ...
        emot_mng = emot_10 if emot_10 else "5440621591387980068"
        if client.me.is_premium:
